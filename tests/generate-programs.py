...
binary_recurse('programs/recursive-cat.alvm', 'concat', '"ABCDEF"', 29)
binary_recurse('programs/recursive-mul.alvm', '*', '0x7ffffffffffffffffffffffffffffffffffffffffffff', 100)
binary_recurse('programs/recursive-add.alvm', '+', '0x7ffffffffffffffffffffffffffffffffffffffffffffffff', 5000000)
binary_recurse('programs/recursive-sub.alvm', '-', '0x7ffffffffffffffffffffffffffffffffffffffffffffffff', 5000000)
unary_recurse('programs/recursive-div.alvm', '/', 13, 1000000)
unary_recurse('programs/recursive-lsh.alvm', 'lsh', 65535, 10000)
unary_recurse('programs/recursive-ash.alvm', 'ash', 65535, 10000)
unary_recurse('programs/recursive-pubkey.alvm', 'pubkey_for_exp', '', 10000)
unary_recurse('programs/recursive-not.alvm', 'lognot', '', 10000000)
many_args('programs/args-mul.alvm', '*', 10000)
many_args('programs/args-add.alvm', '+', 10000)
many_args('programs/args-sub.alvm', '-', 10000)
many_args('programs/args-sha.alvm', 'sha256', 10000)
many_args('programs/args-cat.alvm', 'concat', 10000)
many_args('programs/args-any.alvm', 'any', 3000000)
many_args('programs/args-all.alvm', 'all', 3000000)
many_args('programs/args-and.alvm', 'logand', 10000)
many_args('programs/args-or.alvm', 'logior', 10000)
many_args('programs/args-xor.alvm', 'logxor', 10000)
many_args_point('programs/args-point_add.alvm', 'point_add', 12000)
many_args('programs/args-unknown-1.alvm', '0x7fffffff00', 5000)
many_args('programs/args-unknown-2.alvm', '0x7ff40', 3000)
many_args('programs/args-unknown-3.alvm', '0x7ff80', 3000)
many_args('programs/args-unknown-4.alvm', '0x7ffc0', 3000)
unary_recurse('programs/args-unknown-5.alvm', '0x7ff00', '0xffffffffffffff', 3000000)
unary_recurse('programs/args-unknown-6.alvm', '0x001', '0xfffffffffffff', 30000000)
unary_recurse('programs/args-unknown-7.alvm', '0x041', '0xfffffffffffff', 30000000)
unary_recurse('programs/args-unknown-8.alvm', '0x081', '0xfffffffffffff', 30000000)
unary_recurse('programs/args-unknown-9.alvm', '0x0c1', '0xfffffffffffff', 30000000)
recursive_cons('programs/recursive-cons.alvm', 10000000)

# this program attempts to wrap around a 64 bit cost counter
softfork_wrap('programs/softfork-1.alvm', '0x00ffffffffffffff45')
# this program attempts to wrap around a 32 bit cost counter
softfork_wrap('programs/softfork-2.alvm', '0x00ffffff45')
